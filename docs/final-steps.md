...
- **Capstone Proposal:** The completed [Capstone Proposal](capstone-proposal-guidelines.md){target="_blank"} must submitted prior to the start of the semester. This proposal will be used as a guide for what you proposed to do, and what remains to be completed.
