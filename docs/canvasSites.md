...
Self-enroll for one of the sites, using the following instructions.
...
You can switch enrollment to either site at any time; however, you will be responsible to meet all set deadlines on the Standard Timeline for that year, even if you switch after certain deadlines have passed.

Please contact Dr. Salcedo for any issues signing up for a Canvas Page or if you questions about switching sites.